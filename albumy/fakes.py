...
def fake_photo(count=30):
    ...
    for i in range(count):
        ...
        # Use PNG to avoid system JPEG encoder/decoder dependency issues
        filename = 'random_%d.png' % i
        r = lambda: random.randint(128, 255)
        img = Image.new(mode='RGB', size=(800, 800), color=(r(), r(), r()))
        img.save(os.path.join(upload_path, filename), format='PNG')

        # Use description as default alt text for seed data; no ML needed
